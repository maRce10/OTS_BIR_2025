...
## Day 1 ([Video](https://udecr.zoom.us/rec/share/KYr3l1GlHfxQ3zu791jfKfNas_VUMmfIK__uhr_mF_B32-KYxpE36YbPSQaMjbpc.0Y_xfwv6YwjHU9jd))
...
-   Download [this folder](https://www.dropbox.com/scl/fo/jdwy6lj4ewjmz3frr9xn6/AGps--QHojxXTk8EXPEpIEg?rlkey=7nrmeamugda1h67gyt4wn9b1v&st=gujimf4l&dl=0) into the course project directory
:::
...
1.  Use the function `query_xenocanto()` from the [suwo package](https://github.com/maRce10/suwo) to check the availability of recordings for a species of interest in [Xeno-Canto](https://xeno-canto.org/). This repository offers recordings for several taxonomic groups. Take a look at [this link](https://xeno-canto.org/explore/taxonomy) for a list of species by taxonomic group. Check [this brief tutorial](get_online_recordings.qmd) on how to get the recordings with suwo.
...
## Day 2 ([Video](https://udecr.zoom.us/rec/share/wAwNw4_NpfCe2saHaqLkpq79XrDC8HkptZ4VUR8b1kM-mmVhMhDBDxLa7EvvBgjU.piSvXLNEJmBa97FM?startTime=1747152336000))
...
## Day 3 ([Video](https://udecr.zoom.us/rec/share/LkAmlALctf84Vv0ul4vYop17ociVyiTNekQcRlDQ7x2nHawfXuaar69WvdX_gedx.KKc-Yf_vVY5ax3EX))
...
## Day 4 ([Video](https://udecr.zoom.us/rec/share/zeyjFHFwdxbdk_wDFQBqMbCNrjgeyOnDkmRq1FdriwkmHl_BQZ0ae9ceNSt045no.pz5jIz5-5mRO4hwu))
...
## Day 5 ([Video](https://udecr.zoom.us/rec/share/yDPRNxxUglTgj8kJjnGzD9j6AZJyWddUC9xUdiHjYmM6T8Y-NtTYNKNgqNQe7o4q.NHTjgj4GQlH-0zs4))
