...
<center><img src="images/analysis_workflow.png" alt="automated signal detection diagram" width="100%" height="450"/></center>
...
# filter
filtered <- filter_detection(detection = labeled, 
                             by = "scores")
