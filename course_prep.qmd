...
14) Install FLAC. It can be downloaded from here (**not critical**): [https://xiph.org/flac/download.html](http://sox.sourceforge.net/) 

15) Note that you can also run the code using google colab. Take a look at this notebook: [https://colab.research.google.com/](https://colab.research.google.com/drive/1nXzX-SQW8zgKtLS5GvgTObhLYeNPMzVL?usp=sharing)
